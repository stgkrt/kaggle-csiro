...
class EachBranchTransModel(nn.Module):
    def __init__(
        self,
        imu_dim=11,
        tof_dim=25,
        ...
        super(EachBranchTransModel, self).__init__()
        ...
        print(
            f"Initializing EachBranch Transformer Model with"
...
if __name__ == "__main__":
    ...
    simple_model = EachBranchTransModel(imu_dim, tof_dim, thm_dim, n_classes)
