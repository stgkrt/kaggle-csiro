...
class BranchCNNModel(nn.Module):
    def __init__(
        self,
        imu_dim=11,
        tof_dim=25,
        ...
        super(BranchCNNModel, self).__init__()
        ...
        class_in_filters = imu_out_filters + tof_out_filters + thm_out_filters
...
if __name__ == "__main__":
    ...
    simple_model = BranchCNNModel(imu_dim, tof_dim, thm_dim, n_classes)
