...
class SimpleCNNModel(nn.Module):
    def __init__(
        ...
        self.stride = stride
        print(
            f"Initializing SimpleCNNModel with imu_dim={imu_dim}, "
...
if __name__ == "__main__":
    ...
    simple_model = SimpleCNNModel(imu_dim, n_classes)
    dummy_input_simple = torch.randn(batch_size, pad_len, imu_dim)
    dummy_input_simple = {"features": dummy_input_simple}
