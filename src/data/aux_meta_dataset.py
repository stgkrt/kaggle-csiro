...
from src.data.dataset_process import (
    get_features_and_labels_and_meta,
    get_input_features,
    get_labels,
...
class AuxMetaDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        meta_features = self.meta_features_list[idx]
...
if __name__ == "__main__":
    ...
    for inputs, labels in train_loader:
        ...
        print(inputs["meta_features"].shape)
